...
export default function Circle({ style, width, height, color, ...children }: CircleProps) {
  if (!color) {
    color = "#F4C36C"
  }
  ...
  return <SvgXml style={style} xml={desk} width={width} height={height} >{children}</SvgXml>;
}