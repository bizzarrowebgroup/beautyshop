...
const ENTRIES = [
  {
    illustration:
      "https://firebasestorage.googleapis.com/v0/b/beautyshop-afe23.appspot.com/o/amico.png?alt=media&token=ec6ff44b-5183-4686-88b3-b1dc5485d45d",
  ...
  {
    illustration:
      "https://firebasestorage.googleapis.com/v0/b/beautyshop-afe23.appspot.com/o/Buonefeste.png?alt=media&token=35d56d63-cb1c-413e-970b-399463578daa",
    navigationAction: undefined,
    linkUrl: undefined,
  },
  {
    illustration:
      "https://firebasestorage.googleapis.com/v0/b/beautyshop-afe23.appspot.com/o/parereconta.png?alt=media&token=2e7c5886-232c-4e40-82e8-2c432e8c5fa3",
    navigationAction: undefined,
    linkUrl: undefined,
  },
];
...
export default function HomePage({
  ...
  const loading = async () => {
    ...
    if (commercianti && foto) {
      const comFin = commercianti.map((com) => ({
        ...com,
        mainPhoto: foto.find(
          (fot) => fot.commercianti === com.id && fot.isMain == true
        ),
        photos: foto.map((item) => {
  ...
  const renderCards = (item, index) => {
    ...
    let economyColor = "rgba(133, 194, 170, 0.4)",
      economyTitle = "€",
      economyTColor = "#008D56";
    if (economy) {
      switch (economy) {
        case 1:
          ...
          <Image
            ...
            source={
              mainPhoto
                ? { uri: mainPhoto.url }
                : {
                    uri: "https://images.unsplash.com/photo-1582582450303-48cc2cfa2c43?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1650&q=80",
                  }
            }
          />
          <View
  ...
  const renderHorizontalCards = (item, index) => {
    let { title, stars, via, desc, mainPhoto, economy, id } = item;
    let economyColor = "rgba(133, 194, 170, 0.4)",
      economyTitle = "€",
      economyTColor = "#008D56";
  ...
  const presseProfile = () => {
    if (user && userData) {
      const { toBecompleted, userId, displayName, email, phoneNumber } =
        userData;
      if (toBecompleted === true) {
        navigation.navigate("Auth", {
          screen: "CompleteSocial",
          params: {
            userid: userId,
            nomecognome: displayName,
            email: email,
  ...
  const _renderItemSearchHeader = () => {
    return (
      <View style={{ marginTop: 10 }}>
        <BaseText color={"#898A8D"} weight={700}>
          {"Saloni"}
        </BaseText>
      </View>
    );
        ...
        {stars > 0 && (
          ...
          >
            ...
            <BaseText
              size={10}
              weight={700}
              styles={{ marginLeft: 5, marginRight: 10, marginTop: 5 }}
            >
              {stars}
            </BaseText>
            <BaseText
        ...
        >
          ...
          <TouchableWithoutFeedback onPress={() => setSearchModal(true)}>
            <View style={styles.searchBar}>
              <BaseText size={12} letterSpacing={0.3} weight={600}>
          ...
          <View style={{ backgroundColor: "transparent" }}>
            ...
            {prenotazioni !== undefined && (
              <View style={{ marginBottom: 20 }}>
                <BaseText
                  weight={700}
                  styles={{ marginHorizontal: 20, marginVertical: 10 }}
                  size={15}
                >
                  {"Ultime prenotazioni"}
                </BaseText>
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              {moment(item.slot_date).format("dddd DD MMMM")} |{" "}
                            </BaseText>
                            <BaseText weight={500} color={Colors.light.bianco}>
                              {item.slot_time} -{" "}
                            </BaseText>
                            <BaseText weight={500} color={Colors.light.bianco}>
                              {item.slot_end_time}
                          ...
                          <BaseText weight={400} color={Colors.light.bianco}>
                            {item.totale + " €"}
                          </BaseText>
                        </TouchableOpacity>
                      </LinearGradient>
              ...
              <>
                <View style={{ paddingHorizontal: 20, paddingVertical: 10 }}>
                  ...
                  <BaseText
                    ...
                    // color={"white"}
                  >
                    {"Spazi pagati dai nostri partner"}
                  </BaseText>
                </View>
                <FlatList
