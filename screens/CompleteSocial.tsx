...
const CompleteSocial = ({ navigation, route }) => {
  ...
  async function completeProfile() {
    ...
    let result = await completeSocialProfile({
      email,
      phone,
      name: nomecognome,
      userId,
    ...
    if (result.type == "complete_social") {
      showToast(
        "Completa profilo",
        "Sei riuscito a completare il tuo profilo con successo!",
        "success",
        "bottom",
        2000
      );
          ...
          <View style={{ flex: 1 }}>
              ...
              <>
                <View style={{ paddingLeft: 20 }}>
                  ...
                  <BaseText
                    ...
                    styles={{ marginTop: 30 }}
                  >
                    {"Per registrarti conferma il tuo nome e cognome"}
                  </BaseText>
                  <AppTextInput
                    name="name"
                    leftIcon="account"
                ...
                >
                  <TouchableOpacity
                    disabled={validatore1 ? false : true}
                    onPress={() => checkAndGoOn(1)}
                    activeOpacity={0.4}
                    style={{
                  ...
                  >
                    <BaseText
                      color={validatore1 ? Colors.light.bianco : "#888888"}
                      weight={700}
                      letterSpacing={0.77}
                      size={13}
                    >
            ...
            {schermata === 2 && (
              <>
                <View style={{ paddingLeft: 20 }}>
                  ...
                  >
                    {
                      "Inserisci la tua email per invarti comunicazioni riguardanti le tue prenotazioni"
                    }
                  </BaseText>
                  <AppTextInput
                    name="Email"
                ...
                >
                  <TouchableOpacity
                    disabled={validatore2 ? false : true}
                    onPress={() => checkAndGoOn(2)}
                    activeOpacity={0.4}
                    style={{
                  ...
                  >
                    <BaseText
                      color={validatore2 ? Colors.light.bianco : "#888888"}
                      weight={700}
                      letterSpacing={0.77}
                      size={13}
                    >
            ...
            {schermata === 3 && (
              <>
                ...
                >
                  <TouchableOpacity
                    disabled={validatore3 ? false : true}
                    onPress={() => checkAndGoOn("+")}
                    activeOpacity={0.4}
                    style={{
                  ...
                  >
                    <BaseText
                      color={validatore3 ? Colors.light.bianco : "#888888"}
                      weight={700}
                      letterSpacing={0.77}
                      size={13}
                    >
              ...
              <>
                <View style={{ paddingLeft: 20 }}>
                  ...
                  <View style={{ marginVertical: 20 }}>
                    ...
                    >
                      <BaseText styles={{ maxWidth: "80%" }}>
                        {"Accetto di iscrivermi alla newsletter"}
                      </BaseText>
                      <CustomSwitch
                    ...
                    >
                      <BaseText styles={{ maxWidth: "80%" }}>
                        {"Accetto di profilarmi con i cookies del servizio"}
                      </BaseText>
                      <CustomSwitch
                        isEnabled={cookie}
